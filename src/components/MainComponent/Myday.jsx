  ...
  return (
    <div className="mt-2 grid grid-flow-col grid-cols-5 gap-2 md:justify-start justify-center md:p-0 p-2">
      ...
      <div className=" rounded-lg relative overflow-hidden h-48">
        ...
        <p className=" text-sm text-white pointer-events-none font-bold absolute bottom-2 left-2 z-10">
          Phyo Thu Kha
        </p>
      </div>
      <div className=" rounded-lg relative overflow-hidden h-48">
        ...
        <p className=" text-white text-sm pointer-events-none font-bold absolute bottom-2 left-2 z-10">
          Phyo Thu Kha
        </p>
      </div>
      <div className=" rounded-lg relative overflow-hidden h-48">
